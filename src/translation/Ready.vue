        ...
        <div class="card-body">
          <div class="form-group">
            <textarea
              class="form-control"
              rows="10"
              v-model="stores.translatestates.byGoogle"
            ></textarea>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="form-group">
            <textarea
              class="form-control"
              rows="10"
              v-model="stores.translatestates.byPapago"
            ></textarea>
          </div>
        </div>
      </div>
...
function initialTranslateTerms() {
  const source =
  ...
  stores.translatestates.source = source + "\n" + source + "\n" + source;
