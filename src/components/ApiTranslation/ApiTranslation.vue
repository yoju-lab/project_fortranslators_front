...
<template>
  <div class="row row-cols-1 row-cols-md-2 text-center">
        ...
        <div class="card-body">
          <div class="form-group">
            <textarea
              class="form-control"
              rows="8"
              v-model="translatedDoc.source"
            ></textarea>
          </div>
        </div>
        <div class="card-body">
          <button class="btn btn-outline-primary" @click="sendToTranslateAPI">
            Text Translation
          </button>
        </div>
      </div>
    ...
    <div class="col">
      <div class="card mb-4 rounded-3 shadow-sm">
        <div class="card-header py-3">
          <h4 class="my-0 fw-normal">Document</h4>
        </div>
        <div class="card-body">
          <div class="form-group">
        ...
        <div class="card-body">
          <button class="btn btn-outline-primary">Doc Translation</button>
        </div>
      </div>
    </div>
  </div>
